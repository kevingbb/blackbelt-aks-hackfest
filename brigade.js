...
events.on("push", (brigadeEvent, project) => {
    ...
    console.log(">>> github commit " + brigadeEvent.revision.commit)
...
function kubeJobRunner (config, k) {
    ...
    k.tasks = [
        `kubectl set image deployment/heroes-web-deploy heroes-web-cntnr=khacr.azurecr.io/azureworkshop/rating-web:${config.get("imageTag")}`
    ]
}
